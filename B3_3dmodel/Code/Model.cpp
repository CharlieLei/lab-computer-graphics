...
void Model::Draw(Shader shader, glm::mat4 model, glm::mat4 view, glm::mat4 projection, glm::vec3 color) {
    shader.use();
...
void Model::computeNormals() {
    for (int i = 0; i < modelVertices.size(); i++) {
        ...
        if (e->pair == nullptr)
            continue;
        normal += getNormalOfFaceOnTheSideOfThisHalfEdge(e);
...
glm::vec3 Model::getNormalOfFaceOnTheSideOfThisHalfEdge(HalfEdge *e) {
